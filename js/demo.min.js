!function () {
    ...
    "use strict";
    function a(a) {
        a.when("/", {templateUrl: "tpl/demo/dashboard.html"}).when("/:folder/:tpl", {
    ...
    function c(a) {
        a.configure({v: "3.17", libraries: "weather,geometry,visualization"})
    }

    angular.module("material-lite").run(["$rootScope", "APP", a]).run(["$rootScope", "$timeout", b]).config(["uiGmapGoogleMapApiProvider", c])
}(), angular.module("app.constants", []).constant("APP", {version: "1.1.0"}), function () {
    "use strict";
    function a(a) {
    ...
    function a(a, b) {
        var c = function (a, b) {
            ...
            for (var e = [], f = 0; a > f; ++f)if (e.length) {
                var g = 10, h = e[e.length - 1] - g, i = e[e.length - 1] + g;
    ...
    "use strict";
    function a() {
        var a = document.querySelector("#p1"), b = document.querySelector("#p3");
    ...
    function a(a, b, c) {
        ...
        a.upload = function (a) {
            if (a && a.length)for (var c = 0; c < a.length; c++) {
                var f = a[c];
                b.upload({url: "#", file: f}).progress(d).success(e)
            }
        }, a.$watch("files", function (b) {
            if (a.formUpload = !1, void 0 !== b && null !== b)for (var c = 0; c < b.length; c++)a.errorMsg = void 0, f(b[c])
        })
    }
    ...
    "use strict";
    function a(a) {
        a.map = {center: {latitude: 40.399516, longitude: -22.703348}, zoom: 2}, a.centerOn = function (b, c) {
            a.map.center = {latitude: b, longitude: c}
        };
        var b = [];
        b.push({id: 0, latitude: 52.369371, longitude: 4.894494, title: "Amsterdam"}), b.push({
            id: 1,
            latitude: 40.712942,
            longitude: -74.005774,
            title: "New York"
        }), b.push({id: 2, latitude: 41.385196, longitude: 2.173315, title: "Barcelona"}), b.push({
            id: 3,
            latitude: 37.764355,
    ...
    "use strict";
    function a(a, b) {
        a.map = {center: {latitude: 40.399516, longitude: -22.703348}, control: {}, zoom: 2}, b.then(function (b) {
            a.searchFor = function (c) {
                var d = new b.Geocoder;
                d.geocode({address: c}, function (c, d) {
    ...
    function a(a) {
        var b = !1;
        a.map = {
            center: {latitude: 52.369371, longitude: 4.894494},
            control: {},
            events: {
    ...
    "use strict";
    function a(a) {
        a.map = {center: {latitude: 40.399516, longitude: -22.703348}, zoom: 3}, a.centerOn = function (b, c) {
            a.map.center = {latitude: b, longitude: c}
        };
        var b = [];
        b.push({id: 0, latitude: 52.369371, longitude: 4.894494, title: "Amsterdam"}), b.push({
    ...
    function a(a, b, c, d) {
        ...
        a.data = e, a.tableParams = new c({page: 1, count: 10, sorting: {firstname: "asc"}}, {
            filterDelay: 50,
            total: e.length,
            getData: function (a, b) {
                var c = b.filter().search, f = [];
    ...
    angular.module("material-lite").controller("TablesDataController", ["$scope", "PlaceholderTextService", "ngTableParams", "$filter", a])
}(), function () {
    "use strict";
    function a() {
        return {
            restrict: "A", link: function (a, b, c) {
                angular.forEach(b.children(), function (a) {
                    var b = angular.element(a), c = b.attr("class").match(/mdl-color--(.*?)($|\s)/g)[0];
    ...
    "use strict";
    function a() {
        return {restrict: "E", templateUrl: "tpl/demo/partials/header.html", replace: !0}
    }
    ...
    "use strict";
    function a() {
        return {restrict: "E", templateUrl: "tpl/demo/partials/sidebar.html", replace: !0}
    }
    ...
    function b(a, b, c) {
        function d(a, b) {
            return {text: a, datetime: moment().format(), me: b}
        }

        function e() {
            var d = a.defer();
            return b.get(c.endpoint, {cache: "true"}).then(function (a) {
                d.resolve(a)
            }, function (a) {
            }), d.promise
        }

        return {prepareMessage: d, getConversations: e}
    }

    function c() {
        return {restrict: "EA", controller: "mlChatController", templateUrl: "tpl/partials/chat-widget.html"}
    }
    ...
    function d() {
        ...
        return {restrict: "EA", controller: "mlChatController", link: a}
    }
    ...
    angular.module("ml.chat", []).constant("mlChatConfig", {endpoint: "js/demo/apis/chats.json"}).controller("mlChatController", ["$scope", "mlChatService", a]).factory("mlChatService", ["$q", "$http", "mlChatConfig", b]).directive("mlChatWidget", c).directive("mlChatApp", d).filter("mlChatDate", e)
}(), function () {
    "use strict";
    ...
    function b() {
        return {restrict: "EA", controller: "MenuController"}
    }
    ...
    function e() {
        ...
        return {restrict: "EA", transclude: !0, template: "", replace: !0, require: "^mlMenuGroup", link: a}
    }
    ...
    function f() {
        ...
        return {require: "^mlMenuGroup", link: a}
    }
    ...
    angular.module("ml.menu", []).constant("menuConfig", {closeOthers: !0}).controller("MenuController", ["$scope", "$attrs", "$location", "$rootScope", "menuConfig", a]).directive("mlMenu", b).directive("mlMenuItem", c).directive("mlMenuGroup", d).directive("mlMenuGroupHeading", e).directive("mlMenuTransclude", f).directive("collapse", ["$animate", g])
}(), function () {
    "use strict";
    function a(a) {
        function b(a, b) {
        ...
        return {restrict: "EA", templateUrl: b, link: c}
    }
    ...
    function b(a) {
        ...
        return {restrict: "A", scope: {hoverRegion: "="}, link: b}
    }

    function c() {
        function a() {
            var a = Math.floor(200 * Math.random() + 50), b = Math.floor(200 * Math.random() + 50), c = Math.floor(200 * Math.random() + 50);
            return "rgba(" + a + "," + b + "," + c + ",1)"
        }
    ...
    function a(a, b, c) {
        function d(d) {
            if (this.$scope = d, this.todoFilter = {}, this.activeFilter = 0, this.filters = [{
                    title: "All",
                    method: "all"
                }, {title: "Active", method: "active"}, {
                    title: "Completed",
                    method: "completed"
                }], this.newTodo = {title: "", done: !1, editing: !1}, this.restore(), !a.get("todos")) {
                var e = [];
                e[0] = {title: "Grow my mailing list", done: !0}, e[1] = {
                    title: "Create a killer SAAS business",
                    done: !1
                }, e[2] = {title: "Write autoresponder sequence", done: !1}, a.set("todos", e)
            }
            a.bind(this.$scope, "todos"), this.completedTodos = function () {
                return c("filter")(this.$scope.todos, {done: !1})
        ...
        return d.prototype.saveTodo = function (a) {
            ...
            "active" === a ? (this.activeFilter = 1, this.todoFilter = {done: !1}) : "completed" === a ? (this.activeFilter = 2, this.todoFilter = {done: !0}) : (this.activeFilter = 0, this.todoFilter = {})
        }, d
    }
    ...
    function b(a) {
        ...
        return {restrict: "EA", templateUrl: "tpl/partials/todo-widget.html", replace: !0, link: b}
    }
    ...
    function a() {
        function a(a, b, c) {
            ...
            if (d = c.bodyClass || "", e = "string" == typeof c.offset ? parseInt(c.offset.replace(/px;?/, "")) : 0, d) {
                var f = document.getElementsByClassName(d), g = f.length, h = angular.element(f[g - 1]), i = b[0].offsetTop, j = b[0].clientWidth;
